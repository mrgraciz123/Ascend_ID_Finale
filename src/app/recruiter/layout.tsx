      ...
      <div className="md:hidden flex items-center justify-between p-4 border-b border-white/5 bg-[#111827]/80 backdrop-blur-md z-20">
        <Link href="/recruiter/dashboard" className="flex items-center gap-2.5">
          ...
          <span className="font-bold tracking-tight text-white text-sm">
            AscendID <span className="text-[10px] text-gray-400 font-normal border border-white/10 rounded px-1 py-0.5 ml-1 bg-white/5">Recruiter</span>
          </span>
        </Link>
      ...
      `}>
        ...
        <div className="p-6 hidden md:flex flex-col gap-1">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-lg font-bold text-white tracking-tight">AscendID</h2>
          </div>
          <span className="text-[9px] text-blue-400 ml-13 font-bold tracking-widest uppercase">Recruiter Suite</span>
        </div>
          ...
          <div className="px-6 py-3 border-b border-white/5 mb-4 hidden md:block">
            <div className="flex items-center gap-3 bg-white/[0.02] border border-white/5 p-2.5 rounded-xl">
              <div className="w-8 h-8 rounded-lg bg-blue-600/10 border border-blue-500/20 flex items-center justify-center text-xs font-bold text-blue-400 shrink-0">
                {currentUser.displayName ? currentUser.displayName.substring(0, 2).toUpperCase() : "RC"}
              </div>
              <div className="min-w-0">
                <p className="text-xs font-bold text-white truncate">{currentUser.displayName || "Recruiter"}</p>
